...
# Existing imports ... (keep previous imports)
# Add new model for report
...
# Existing CORS middleware (lines 81-86) remain unchanged

# Existing routes ...

# New endpoint for emergency report
@app.post("/report")
async def receive_report(payload: ReportPayload):
    ...
    return {"status": "received", "detail": "Report logged"}

# Existing feedback endpoint remains unchanged
